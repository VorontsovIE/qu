class AnswersController < ApplicationController
  ...
  # GET /answers/new
  def new
    @answer = Answer.new(question_id: params[:question_id], answer_group: params[:answer_group])
  end
  ...
  private
    ...
    def answer_params
      params.require(:answer).permit(:question_id, :answer_text, :mark_score, :answer_group)
    end
end
